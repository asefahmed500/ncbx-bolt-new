/*
  # Create Tables and Policies Only (Types Already Exist)

  1. Tables
    - `profiles` table with proper foreign key to auth.users
    - `websites` table with foreign key to profiles
...
-- Create profiles table (types already exist)
...
-- Create websites table (types already exist)
