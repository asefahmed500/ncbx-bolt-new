/*
  ...
  1. Enhanced Tables
    - Add domain uniqueness constraint
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_user_id_idx ON websites(user_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_status_idx ON websites(status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_created_at_idx ON websites(created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_updated_at_idx ON websites(updated_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_user_created_idx ON websites(user_id, created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_user_status_idx ON websites(user_id, status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_user_updated_idx ON websites(user_id, updated_at DESC);

-- Create composite index for search functionality
CREATE INDEX CONCURRENTLY IF NOT EXISTS websites_search_idx ON websites 
...
-- Create view for website analytics (optional)
